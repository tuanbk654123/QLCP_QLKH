...
public class CompaniesController : ControllerBase
{
    ...
    public CompaniesController(IMongoClient client, IOptions<MongoDbSettings> options)
    {
    ...
    {
        if (!CanManageCompanies()) return StatusCode(403, new { message = "Bạn không có quyền" });
